...
describe('Embeddings Smoke Tests', () => {
  describe('Maia Router Embeddings API', () => {
    ...
    test('should have consistent embedding dimensions', async () => {
      const texts = [
        'Short text.',
    ...
    test('should generate embeddings with expected model', async () => {
      const response = await fetch(testCredentials.embeddings.endpoint, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  describe('Embedding Quality', () => {
    test('similar texts should have similar embeddings', async () => {
      const texts = [
